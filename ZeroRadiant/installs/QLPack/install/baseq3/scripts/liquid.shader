textures/liquids/clear_ripplet4

//	*********************************************************
//	*      Added for team4 to interact correctly with fog	*
//	*********************************************************
...
textures/liquids/slime1_red2000		
	{
	
		qer_editorimage textures/liquids/slimered.tga
		q3map_lightimage textures/liquids/slimered.tga
		q3map_globaltexture
		qer_trans .5
		...
		{
			map textures/liquids/slimeredc.tga
			tcMod turb .3 .2 1 .05
			tcMod scroll .01 .01
		}
	
		{
			map textures/liquids/slimered.tga
			blendfunc add
			tcMod turb .2 .1 1 .05
			tcMod scale .5 .5
			tcMod scroll .01 .01
