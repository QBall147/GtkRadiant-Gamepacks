...
textures/liquids2/xproto_pool3
	{
		...
		qer_editorimage textures/liquids2/proto_pool3.tga
		q3map_globaltexture
	    	qer_trans .80
                surfaceparm trans
		surfaceparm nonsolid
		...
		{
			map textures/liquids2/proto_pool3.tga
	        ...
	        {
			map textures/liquids2/proto_poolpass2.tga
			blendfunc add
			tcMod scale .5 .6
			tcMod scroll .06 .04
		}
	        {
			map textures/liquids2/proto_poolpass.tga
			blendfunc add
			tcMod scale .2 .2
			tcMod scroll .05 .05
		}
